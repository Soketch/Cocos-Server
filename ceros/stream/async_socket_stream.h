#ifndef __STREAM_ASYNC_SOCKET_STREAM_H__
#define __STREAM_ASYNC_SOCKET_STREAM_H__
...
namespace cero
{
    ...
    public:
        void setWorker(cero::IOManager *v) { m_worker = v; }
        cero::IOManager *getWorker() const { return m_worker; }

        void setIOManager(cero::IOManager *v) { m_iomanager = v; }
        cero::IOManager *getIOManager() const { return m_iomanager; }
    ...
    protected:
        cero::FiberSemaphore m_sem;
        cero::FiberSemaphore m_waitSem;
        ...
        uint32_t m_sn;
        bool m_autoConnect;
        cero::Timer::ptr m_timer;
        cero::IOManager *m_iomanager;
        cero::IOManager *m_worker;
