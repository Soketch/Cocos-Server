/*
增加RSA,AES加密方法,增加Rock协议
*/
#ifndef __STREAM_ZLIB_STREAM_H__
#define __STREAM_ZLIB_STREAM_H__
...
namespace cero
{
    ...
    public:
        ...
        static ZlibStream::ptr Create(bool encode, uint32_t buff_size = 4096,
                                      Type type = DEFLATE, int level = DEFAULT_COMPRESSION, int window_bits = 15, int memlevel = 8, Strategy strategy = DEFAULT);
        ...
        cero::ByteArray::ptr getByteArray();
