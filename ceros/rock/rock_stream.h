...
#include "ceros/stream/async_socket_stream.h"
#include "rock_protocol.h"
#include "ceros/stream/load_balance.h"
...
namespace cero
{
    ...
    class RockStream : public cero::AsyncSocketStream
    {
    public:
        typedef std::shared_ptr<RockStream> ptr;
        typedef std::function<bool(cero::RockRequest::ptr, cero::RockResponse::ptr, cero::RockStream::ptr)> request_handler;
        typedef std::function<bool(cero::RockNotify::ptr, cero::RockStream::ptr)> notify_handler;
    ...
    protected:
        ...
        void handleRequest(cero::RockRequest::ptr req);
        void handleNotify(cero::RockNotify::ptr nty);
    ...
    public:
        ...
        RockConnection();
        bool connect(cero::Address::ptr addr);
    };
