...
namespace cero
{
    ...
    public:
         ...
         * @param[in] address 地址
         */
        static Socket::ptr CreateTCP(cero::Address::ptr address);

        /**
         * @brief 创建UDP Socket(满足地址类型)
         * @param[in] address 地址
         */
        static Socket::ptr CreateUDP(cero::Address::ptr address);
    ...
    public:
        ...
        static SSLSocket::ptr CreateTCP(cero::Address::ptr address);
