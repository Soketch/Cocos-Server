...
namespace cero
{
    ...
    public:
        ...
        uint32_t incUsedTime(uint32_t v) { return cero::Atomic::addFetch(m_usedTime, v); }
        uint32_t incTotal(uint32_t v) { return cero::Atomic::addFetch(m_total, v); }
        uint32_t incDoing(uint32_t v) { return cero::Atomic::addFetch(m_doing, v); }
        uint32_t incTimeouts(uint32_t v) { return cero::Atomic::addFetch(m_timeouts, v); }
        uint32_t incOks(uint32_t v) { return cero::Atomic::addFetch(m_oks, v); }
        uint32_t incErrs(uint32_t v) { return cero::Atomic::addFetch(m_errs, v); }

        uint32_t decDoing(uint32_t v) { return cero::Atomic::subFetch(m_doing, v); }
        void clear();
    ...
    {
    public:
        typedef cero::RWMutex RWMutexType;
        ...
        void update(const std::unordered_map<uint64_t, LoadBalanceItem::ptr> &adds, std::unordered_map<uint64_t, LoadBalanceItem::ptr> &dels);
        void init();
    ...
    private:
        void onServiceChange(const std::string &domain, const std::string &service, const std::unordered_map<uint64_t, ServiceItemInfo::ptr> &old_value, const std::unordered_map<uint64_t, ServiceItemInfo::ptr> &new_value);
