...
namespace cero
{
    ...
    Socket::ptr Socket::CreateTCP(cero::Address::ptr address)
    {
        Socket::ptr sock(new Socket(address->getFamily(), TCP, 0));
        return sock;
    }

    Socket::ptr Socket::CreateUDP(cero::Address::ptr address)
    {
    ...
    bool Socket::bind(const Address::ptr addr)
    {
        ...
        if (uaddr)
        {
            ...
            {
                cero::FSUtil::Unlink(uaddr->getPath(), true);
            }
        }
    ...
    {
        return IOManager::GetThis()->cancelEvent(m_sock, cero::IOManager::READ);
    }

    bool Socket::cancelWrite()
    {
        return IOManager::GetThis()->cancelEvent(m_sock, cero::IOManager::WRITE);
    }
    ...
    SSLSocket::ptr SSLSocket::CreateTCP(cero::Address::ptr address)
    {
